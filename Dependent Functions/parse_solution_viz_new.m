function out = parse_solution_viz_new(out1, G, R, sigma, m, E, opt)
...
if opts.ShowFigure
    ...
    for r=1:m
        ...
        title(sprintf('Route : %d ',r),sprintf('Total Sub-route Time = %.3f',Cost(r)),'Color',colRoute,'FontName','Times New Roman','FontSize',16);
        ax = gca;
        ax.TitleHorizontalAlignment = 'left';
        hold off; view(2);           % ensure a flat 2D view
        camroll(90); daspect([2 1 1]);
    end
